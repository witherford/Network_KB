// Interactive learning centre for the Cisco IOS XE WLC (Catalyst 9800).
// Mounts into the Guides page root. Left rail = modules, right pane = lesson.

import { CURRICULUM } from './wlc-ios-xe-content.js';
import { esc, copyToClipboard, toast, slugify } from '../../utils.js';

const LS_KEY = 'nkb.learning.wlc-ios-xe';
...
function wireSectionInteractions(scope) {
  ...
  // Persist checklist ticks per list via localStorage
